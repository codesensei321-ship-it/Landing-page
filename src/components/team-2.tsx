            ...
            <div className="mx-auto max-w-7xl px-6">
                <div className="grid gap-4 md:grid-cols-2 md:gap-6">
                    <h2 className="text-muted-foreground max-w-4xl text-balance text-4xl font-medium tracking-tight">
                        <span className="text-foreground">Built by outreach experts.</span> <br /> Designed for agencies at scale.
                    </h2>
                    <div className="flex flex-col gap-32 md:mx-auto xl:gap-44">
                        <p className="text-muted-foreground text-balance text-lg">&quot;We&#39;ve managed cold email infrastructure for hundreds of agencies. Coldmail is the platform we wished existed — simple setup, rock-solid deliverability, and pricing that makes sense at scale.&quot; </p>
                        ...
                        <div className="grid grid-cols-[auto_1fr] items-center gap-7">
                            ...
                            <div>
                                <h3 className="text-sm font-medium">Alex Rivera and Jordan Chen</h3>
                                <p className="text-muted-foreground text-sm">Co-founders, Coldmail</p>
                            </div>
                        </div>
                    </div>
                </div>
